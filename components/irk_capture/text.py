...
from . import irk_capture_ns, CONF_IRK_CAPTURE_ID, IRKCaptureComponent, CONF_BLE_NAME

IRKCaptureText = irk_capture_ns.class_(
    "IRKCaptureText", text.Text, cg.Component
)
